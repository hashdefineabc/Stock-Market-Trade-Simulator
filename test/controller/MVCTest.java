...
public class MVCTest {
  ...
  String flexibleValue, askCom, txnDate, flexStockDate1,flexStockDate2 = null;
  String createOptions,nameForCreate,enterTickerName,enterUnits,marketStringForFixed,previousDay,addMoreStocks,portfolioSaved = null;
  ...
  public void setup() {
    ...
    marketStringForFixed = "Market is not closed today yet, previous available closing price will be considered as your transaction price...\n" +
            "Price of the stock considered is of the date ";
    previousDay = LocalDate.now().minusDays(1).toString() + "\n";
    addMoreStocks = "Do you want to add more stocks to this portfolio? (Press 1 for Yes, 0 for No):\n";
    ...
    fixedWeeklyGraph = "Performance of the portfolio testFixed1.csv from 2022-11-17 to 2022-11-10\n" +
            ...
            "2022-11-12:<*\n" +
            "2022-11-11:<*\n" +
            "<* means the value of the portfolio for a particular timestamp is less than the scale\n" +
            "Scale: * = $1518.8933333333332\n";
    fixedMonthlyGraph = "Performance of the portfolio testFixed1.csv from 2022-11-17 to 2022-10-18\n" +
            "2022-11-17:******************************\n" +
            "2022-11-16:******************************\n" +
            "2022-11-15:<*\n" +
            "2022-11-14:<*\n" +
    ...
    fixedYearlyGraph = "Performance of the portfolio testFixed1.csv from NOVEMBER 2022 to DECEMBER 2021\n" +
            "NOV 2022 : ******************************\n" +
            "OCT 2022 : <*\n" +
            "SEP 2022 : <*\n" +
            "AUG 2022 : <*\n" +
  ...
  public void testValueOfFlexiblePortfolio() {
    log = new StringBuilder();
    log.append(menu+portfolioOptions+displayListOfFlexiblePortfolios+valueDate+flexibleValue+menu+exit);
  ...
  public void testCreateANewFlexiblePortfolio() {
    log = new StringBuilder();
    log.append(menu+portfolioOptions+createOptions+nameForCreate+enterTickerName+enterUnits + askCom + txnDate
    ...
    input = new ByteArrayInputStream("1 2 1 testCreate2 GOOG 50 10 2022-11-10 1 MSFT 40 10 2022-11-09 0 7".getBytes());
    ICommandController controller = new CommandController(u, view, input);
    controller.go();
    assertEquals(log.toString(), out.toString());
