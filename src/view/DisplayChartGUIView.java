...
/**
 *The DisplayChartGUIView shows a chart that will display the performance of a portfolio.
 * It extends the JFrame class in order to design the buttons for the display operation.
